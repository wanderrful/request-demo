...
class Database:
    ...
    def get_db(self):
        ...
        if self._is_connected():
            print("- get_db: Already connected to DB!")
    ...
    def close_db(self):
        if self._is_connected():
            ...
            print("- close_db: DB connection has been closed!")
            return True
        else:
            print("- close_db: DB connection was already closed!")
            return False
